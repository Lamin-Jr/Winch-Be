...
function getPlantBuilders() {
  return {
    ...
    // -> Benin
    'Adido Bonou': (villageId) => { return [ buildPlant('Adido', 'Benin DBO 100 Villages', 'BEN_2019_005', 'BEN', 6.830128, 2.528068, villageId, undefined, new Date('2019-09-06'), 31.20, 148.32, 0.00, 62, 0, 1) ]; },
    // -> Mauritania
    'Nimjat': (villageId) => {
      return [ 
    ...
    // -> Sierra Leone
    'Alikalia': (villageId) => { return [ buildPlant('Alikalia', 'Sierra Leone Unops WP2', 'SLL_2019_002', 'WP2', 9.151992, -11.388275, villageId, undefined, undefined, 103.50, 444.86, 0.00, 0, 0, 0, 394) ]; },
    'Bafodia': (villageId) => { return [ buildPlant('Bafodia', 'Sierra Leone Unops WP1', 'SLL_2019_001', 'WP1', 9.684119, -11.731742, villageId, new Date('2019-05-31'), undefined, 36.54, 155.52, 0.00, 0, 0, 0, 167) ]; },
    'Batkanu': (villageId) => { return [ buildPlant('Batkanu', 'Sierra Leone Unops WP1', 'SLL_2019_001', 'WP1', 9.073461, -12.41555, villageId, new Date('2019-05-31'), new Date('2019-11-20'), 16.38, 77.76, 0.00, 79, 1, 3, 80) ]; },
    'Bendugu Mongo': (villageId) => { return [ buildPlant('Bendugu Mongo', 'Sierra Leone Unops WP2', 'SLL_2019_002', 'WP2', 9.535237, -10.957753, villageId, undefined, undefined, 51.75, 222.43, 0.00, 0, 0, 0, 212) ]; },
    'Bindi': (villageId) => { return [ buildPlant('Bindi', 'Sierra Leone Unops WP2', 'SLL_2019_002', 'WP2', 9.915203, -11.447152, villageId, undefined, undefined, 103.50, 444.86, 0.00, 0, 0, 0, 468) ]; },
    'Dogoloya': (villageId) => { return [ buildPlant('Dogoloya', 'Sierra Leone Unops WP2', 'SLL_2019_002', 'WP2', 9.708182, -11.55197, villageId, undefined, undefined, 51.75, 222.43, 0.00, 0, 0, 0, 208) ]; },
    'Falaba': (villageId) => { return [ buildPlant('Falaba', 'Sierra Leone Unops WP2', 'SLL_2019_002', 'WP2', 9.854305, -11.320968, villageId, undefined, undefined, 51.75, 222.43, 0.00, 0, 0, 0, 260) ]; },
    ...
    'Firawa': (villageId) => { return [ buildPlant('Firawa', 'Sierra Leone Unops WP2', 'SLL_2019_002', 'WP2', 9.358892, -11.30088, villageId, undefined, undefined, 51.75, 222.43, 0.00, 0, 0, 0, 268) ]; },
    'Gbendembu': (villageId) => { return [ buildPlant('Gbendembu', 'Sierra Leone Unops WP2', 'SLL_2019_002', 'WP2', 9.108262, -12.20772, villageId, undefined, undefined, 51.75, 222.43, 0.00, 0, 0, 0, 261) ]; },
    ...
    'Kondembaia': (villageId) => { return [ buildPlant('Kondembaia', 'Sierra Leone Unops WP2', 'SLL_2019_002', 'WP2', 9.382413, -11.567958, villageId, undefined, undefined, 51.75, 222.43, 0.00, 0, 0, 0, 212) ]; },
    ...
    'Masumbri': (villageId) => { return [ buildPlant('Masumbri', 'Sierra Leone Unops WP2', 'SLL_2019_002', 'WP2', 8.822325, -11.754525, villageId, undefined, undefined, 51.75, 222.43, 0.00, 0, 0, 0, 236) ]; },
    'Mathoir': (villageId) => { return [ buildPlant('Mathoir', 'Sierra Leone Unops WP2', 'SLL_2019_002', 'WP2', 8.484747, -12.417392, villageId, undefined, undefined, 51.75, 222.43, 0.00, 0, 0, 0, 250) ]; },
    'Musaia': (villageId) => { return [ buildPlant('Musaia', 'Sierra Leone Unops WP1', 'SLL_2019_001', 'WP1', 9.755061, -11.570375, villageId, new Date('2019-05-31'), undefined, 26.46, 155.52, 0.00, 0, 0, 0, 120) ]; },
    ...
    'Sambia Bendugu': (villageId) => { return [ buildPlant('Sambia Bendugu', 'Sierra Leone Unops WP2', 'SLL_2019_002', 'WP2', 9.062537, -11.488232, villageId, undefined, undefined, 103.50, 444.86, 0.00, 0, 0, 0, 427) ]; },
    'Seria': (villageId) => { return [ buildPlant('Seria', 'Sierra Leone Unops WP2', 'SLL_2019_002', 'WP2', 9.46446, -10.923058, villageId, undefined, undefined, 51.75, 222.43, 0.00, 0, 0, 0, 230) ]; },
    'Sinkunia': (villageId) => { return [ buildPlant('Sinkunia', 'Sierra Leone Unops WP1', 'SLL_2019_001', 'WP1', 9.860631, -11.430731, villageId, new Date('2019-05-31'), undefined, 36.54, 155.52, 0.00, 0, 0, 0, 174) ]; },
    'Yiffin': (villageId) => { return [ buildPlant('Yiffin', 'Sierra Leone Unops WP1', 'SLL_2019_001', 'WP1', 9.123019, -11.269533, villageId, new Date('2019-05-31'), undefined, 36.54, 155.52, 0.00, 0, 0, 0, 204) ]; },
    // -> Togo
    ...
    // -> Uganda
    'Agoro': (villageId) => { return [ buildPlant('Agoro (incl. Tumanum B)', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.797533, 33.016575, villageId, undefined, undefined, 76.80, 288.00, 0.00, 0, 0, 0, 235) ]; },
    'Apwoyo TC ': (villageId) => { return [ buildPlant('Apwoyo TC ', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.759322, 32.999982, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 46) ]; },
    'Apyetta TC': (villageId) => { return [ buildPlant('Apyetta TC', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.37173, 32.4165, villageId, undefined, undefined, 76.80, 288.00, 0.00, 0, 0, 0, 189) ]; },
    'Apyetta West': (villageId) => { return [ buildPlant('Apyetta West', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.3062, 32.37103, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 79) ]; },
    'Aweno Olwi': (villageId) => { return [ buildPlant('Aweno Olwi', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.719, 32.7478, villageId, undefined, undefined, 19.20, 72.00, 0.00, 0, 0, 0, 55) ]; },
    'Ayuu Alali': (villageId) => { return [ buildPlant('Ayuu Alali', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.53991, 32.56081, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 102) ]; },
    'Bugoma': (villageId) => { return [ buildPlant('Bugoma', 'Uganda Bunjako Island', 'UGA_2019_003', 'Bunjako', -0.056834, 32.140917, villageId, undefined, undefined, 36.48, 148.32, 0.00, 0, 0, 0, 70) ]; },
    'Burkina': (villageId) => { return [ buildPlant('Burkina', 'Uganda Bunjako Island', 'UGA_2019_003', 'Bunjako', -0.048274, 32.211167, villageId, undefined, undefined, 7.68, 37.54, 7.00, 0, 0, 0, 0) ]; },
    'Kapeta': (villageId) => { return [ buildPlant('Kapeta', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.504054, 32.591669, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 73) ]; },
    'Labayango': (villageId) => { return [ buildPlant('Labayango (School and Village)', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.520616, 32.865017, villageId, undefined, undefined, 19.20, 72.00, 0.00, 0, 0, 0, 44) ]; },
    'Lapidiyenyi': (villageId) => { return [ buildPlant('Lapidiyenyi', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.581635, 32.931536, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 199) ]; },
    'Lelapwot West': (villageId) => { return [ buildPlant('Lelapwot West', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.6269, 32.708736, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 53) ]; },
    'Logwak': (villageId) => { return [ buildPlant('Logwak', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.657853, 32.740582, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 79) ]; },
    'Loromibeng': (villageId) => { return [ buildPlant('Loromibeng A + B', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.758299, 33.039266, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 43) ]; },
    'Moroto East': (villageId) => { return [ buildPlant('Moroto East', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.693575, 32.930281, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 44) ]; },
    'Muddu Central': (villageId) => { return [ buildPlant('Muddu Central', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.497164, 32.452439, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 47) ]; },
    'Ngomoromo': (villageId) => { return [ buildPlant('Ngomoromo', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.687719, 32.58713, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 97) ]; },
    'Oboko TC': (villageId) => { return [ buildPlant('Oboko TC', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.670277, 32.984139, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 48) ]; },
    'Ogili TC': (villageId) => { return [ buildPlant('Ogili TC', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.409353, 32.496177, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 131) ]; },
    'Opoki': (villageId) => { return [ buildPlant('Opoki', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.429328, 32.716621, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 54) ]; },
    'Otaa': (villageId) => { return [ buildPlant('Otaa', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.486728, 32.478779, villageId, undefined, undefined, 19.20, 72.00, 0.00, 0, 0, 0, 45) ]; },
    'Paloga Central': (villageId) => { return [ buildPlant('Paloga Central', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.58893, 32.94357, villageId, undefined, undefined, 76.80, 288.00, 0.00, 0, 0, 0, 219) ]; },
    'Pangira / Licwar Central': (villageId) => { return [ buildPlant('Pangira / Licwar Central', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.614721, 32.651851, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 123) ]; },
    'Pany Buk East and West ': (villageId) => { return [ buildPlant('Pany Buk East and West ', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.670064, 32.954506, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 48) ]; },
    'Pawena TC': (villageId) => { return [ buildPlant('Pawena TC', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.283056, 32.67194, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 100) ]; },
    'Potika ': (villageId) => { return [ buildPlant('Potika ', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.719951, 32.881144, villageId, undefined, undefined, 38.40, 144.00, 0.00, 0, 0, 0, 114) ]; },
    'Ssenyondo': (villageId) => { return [ buildPlant('Ssenyondo', 'Uganda Bunjako Island', 'UGA_2019_003', 'Bunjako', -0.068013, 32.186464, villageId, undefined, undefined, 72.96, 288.00, 0.00, 0, 0, 0, 200) ]; },
    'Ywaya': (villageId) => { return [ buildPlant('Ywaya', 'Uganda GIZ 25', 'UGA_2019_004', 'GIZ', 3.694761, 33.080893, villageId, undefined, undefined, 19.20, 72.00, 0.00, 0, 0, 0, 35) ]; },
  }
}
