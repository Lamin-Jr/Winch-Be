...
function getPlantBuilders() {
  return {
    ...
    'Fintonia': (villageId) => { return [ buildPlant('Fintonia', 'Sierra Leone Unops WP1', 'SLL_2019_001', 'WP1', 9.672972, -12.225753, villageId, new Date('2019-05-31'), undefined, 26.46, 155.52, 0.00, buildOrganization(buildOrganizationBasicInfo('Hospital Road', buildCustomerContacts([ '+232075057055', '+232033570611' ]))), 80, 1, 0, 20) ]; },
    ...
    'Kathantha Yimboi': (villageId) => { return [ buildPlant('Kathantha Yimboi', 'Sierra Leone Unops WP1', 'SLL_2019_001', 'WP1', 9.545878, -12.170625, villageId, new Date('2019-05-31'), undefined, 16.38, 77.76, 0.00, buildOrganization(buildOrganizationBasicInfo('', buildCustomerContacts([ '+232075057055', '+232033570611' ]))), 62, 1, 0, 20) ]; },
    ...
    'Musaia': (villageId) => { return [ buildPlant('Musaia', 'Sierra Leone Unops WP1', 'SLL_2019_001', 'WP1', 9.755061, -11.570375, villageId, new Date('2019-05-31'), undefined, 26.46, 155.52, 0.00, buildOrganization(), 0, 0, 0, 120) ]; },
