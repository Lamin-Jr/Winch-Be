...
function getPlantBuilders() {
  return {
    ...
    'Yiffin': (villageId) => { return [ buildPlant('Yiffin', 'Sierra Leone Unops WP1', 'SLL_2019_001', 'WP1', 9.123019, -11.269533, villageId, new Date('2019-05-31'), new Date('2020-06-24'), 36.54, 155.52, 0.00, buildOrganization(buildOrganizationBasicInfo('Central Town', buildCustomerContacts([ '+232075057055', '+232033570611' ]))  ), 204, 1, 1, 20) ]; },
    // -> Togo
