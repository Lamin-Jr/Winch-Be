...
module.exports.buildPoles = () => {
  return new Promise((resolve, reject) => {
    ...
    poles.forEach((pole, index) => {
      let filter = {_id: pole._id};

      Pole.findOneAndUpdate(filter, {$set: { code:pole.code, geo:pole.geo}}, {new: true}, (err, docs) => {
        if(docs){

            console.log(`I find ID ${pole._id} Update data`)
...
function getPoles() {
  return [
    ...
    buildPole('5e0efc42c6eb2f27e0f6a10e', 'Pole 31', 6.82998107, 2.52833380),
    buildPole('5e0efc42c6eb2f27e0f6a10f', 'Pole 32', 6.83011129, 2.52848880),
    ...
    buildPole('5e0efc42c6eb2f27e0f6a128', 'Pole 57', 6.83114820, 2.52765027),
    ...
    buildPole('5e0efc42c6eb2f27e0f6a12c', 'Pole 61', 6.83196150, 2.52736819),
    ...
    buildPole('5e0efc42c6eb2f27e0f6a133', 'Pole 68', 6.83311700, 2.53079142),
    buildPole('5e0efc42c6eb2f27e0f6a134', 'Pole 69', 6.83324336, 2.53116290),
    buildPole('5e0efc42c6eb2f27e0f6a135', 'Pole 70', 6.83336973, 2.53153429),
    buildPole('5e0efc42c6eb2f27e0f6a136', 'Pole 71', 6.83349701, 2.53190550),
    ...
    buildPole('5e0efc42c6eb2f27e0f6a139', 'Pole 74', 6.83175478, 2.52937610),
    ...
    buildPole('5e0efc42c6eb2f27e0f6a13c', 'Pole 77', 6.82368601, 2.53092850),
    ...
    buildPole('5e0efc42c6eb2f27e0f6a147', 'Pole 88', 6.83171216, 2.53186760),
