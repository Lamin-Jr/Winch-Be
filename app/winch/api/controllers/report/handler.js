...
exports.list = (req, res, next) => {
  BasicRead.all(req, res, next, Report, req._q.filter, req._q.skip, req._q.limit, { _id: 1}, req._q.sort);
};

exports.detailed = (req, res, next) => {
  BasicRead.byId(req, res, next, Report, req.params.handlerId, req._q.proj);
};
