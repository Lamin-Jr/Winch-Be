module.exports.initExcelJS = () => {
  return require('exceljs');
}

module.exports.buildBasicDocumentOption = (workbook) => {
  const now = new Date();
  workbook.creator = 'Winch Energy Italy S.r.l.';
  workbook.lastModifiedBy = 'Winch Energy Italy S.r.l.';
  workbook.created = now;
  workbook.modified = now;
  workbook.lastPrinted = now;
}

module.exports.buildPortraitPageSetup = (workbook, margins = buildDefaultMargins(), size = buildPaperSize('xlPaperA4')) => {
  workbook.pageSetup = {
    ...workbook.pageSetup,
    ...buildPageSetup('portrait', margins, size).pageSetup
  }
}

module.exports.buildLandscapePageSetup = (workbook, margins = buildDefaultMargins(), size = buildPaperSize('xlPaperA4')) => {
  workbook.pageSetup = {
    ...workbook.pageSetup,
    ...buildPageSetup('landscape', margins, size).pageSetup
  }
}
